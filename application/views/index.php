			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<div class="w3_navigation_pos">
						<h1><a href="home">Sunat Modern</a></h1>
					</div>
				</div>
	...
	<!-- <div class="agileits_reservation">
					<form action="#" method="post">
						<div class="cuisine"> 
							...
							<input type="text" name="Location" placeholder="Masukkan nama" required="">
						</div>
						...
						<div class="agileits_reservation_grid">
							<div  class="span1_of_1 book_date"> 
								...
								<input class="date" id="datepicker" name="Text" placeholder="Pilih tanggal"  type="text" required="">
							</div>
